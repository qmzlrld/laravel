...
<header>
    <div class="nav">
        ...
        <div class="nav-links">
            <a class="btn" href="<?php echo e(route('home')); ?>">Главная</a>
            <?php if(auth()->guard()->check()): ?>
                <a class="btn" href="<?php echo e(route('profile')); ?>">Профиль</a>
                <?php if(auth()->user()->is_admin): ?>
                    <a class="btn" href="<?php echo e(route('admin.bookings.index')); ?>">Админ</a>
                <?php endif; ?>
            ...
            <?php if(auth()->guard()->guest()): ?>
                ...
                <a class="btn accent" href="<?php echo e(route('register')); ?>">Регистрация</a>
            <?php endif; ?>
        </div>
    </div>
</header>
...
<footer>
    Сервис бронирования столиков · <?php echo e(date('Y')); ?>

</footer>
</body>
</html>
<?php /**PATH C:\OSPanel\home\laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>